...
if [[ -z $1 || -z $2 ]]; then
  echo "ERROR: usage: $0 <size> <threads>" >&2
  exit 1
fi
...
out_csv="analysis/openmp_${size}_${threads}_runs.csv"
summary_txt="analysis/openmp_${size}_${threads}_summary.txt"
