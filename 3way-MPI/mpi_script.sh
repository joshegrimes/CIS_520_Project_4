...
# params
size=$1 # e.g. "60M"
ranks=$SLURM_NTASKS  # e.g. "4"

# prepare output files
out_csv="analysis/mpi_${size}_${ranks}_runs.csv"
summary_txt="analysis/mpi_${size}_${ranks}_summary.txt"
